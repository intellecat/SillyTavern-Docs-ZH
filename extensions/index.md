...
- **<i class="fa-solid fa-cloud-arrow-down"></i> 安装扩展**：从 Git 仓库 URL 导入[第三方扩展](#第三方扩展)
...
!!!tip
下载扩展**必须**安装 git。如果尚未安装，请按照 [Git 安装页面](https://git-scm.com/downloads)上的说明操作。
!!!

您可以直接在应用中浏览所有可用扩展的列表：前往 **<i class="fa-solid fa-cubes"></i> 扩展** => **下载扩展和资源**菜单，点击 **<i class="fa-solid fa-plug-circle-exclamation"></i> 加载资源列表**按钮。要安装扩展，点击 **<i class="fa-solid fa-download"></i> 下载**按钮。要了解某个扩展的详细信息，点击其名称旁的 **<i class="fa-solid fa-arrow-up-right-from-square"></i> 链接**按钮打开其 GitHub 页面。
...
使用可用的天气 API 之一提供天气信息，作为斜杠命令或函数工具。
:::
...
在通过 **<i class="fa-solid fa-cloud-arrow-down"></i> 安装扩展**导入扩展之前，请务必确保您信任来源。
我们对第三方扩展造成的任何损害不承担责任。
!!!

要安装第三方扩展，请前往 **<i class="fa-solid fa-cubes"></i> 扩展** => **<i class="fa-solid fa-cloud-arrow-down"></i> 安装扩展**菜单，粘贴扩展仓库的 URL。您可以选择指定分支，以及（在[多用户](../Administration/multi-user.md)场景下）安装目标：所有用户或仅当前用户。扩展将自动下载并加载。
